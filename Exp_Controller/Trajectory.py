...
class Trajectory():
  ...
  def traj_circle(self):
    ...
    self.traj_acc[0] = -A*w**2*np.cos(w*self.t); self.traj_acc[1] = -A*w**2*np.sin(w*self.t); self.traj_acc[2] = 8.8
  ...
  def stop_track(self):
    ...
    self.traj_acc[0] = 0.0; self.traj_acc[1] = 0.0;  self.traj_acc[2] = 8.5
